...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Data.Teller.DateHelpers"] = $PS["Data.Teller.DateHelpers"] || {};
  var exports = $PS["Data.Teller.DateHelpers"];
  var Data_Array = $PS["Data.Array"];
  var Data_Date = $PS["Data.Date"];
  var Data_DateTime = $PS["Data.DateTime"];
  ...
  var safeAdjust = function (d) {
      return function (dt) {
          ...
          throw new Error("Failed pattern match at Data.Teller.DateHelpers (line 40, column 5 - line 42, column 22): " + [ maybeRes.constructor.name ]);
      };
  };
  var iterateDateRange = function (dStart) {
          ...
          return function (mapper) {
              ...
              return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
                  return function (dateIndex) {
                      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(acc)([ mapper(safeAdjust(Data_Time_Duration.Days(Data_Int.toNumber(dateIndex)))(dStart)) ]);
                  };
              })([  ])(dateIndexes);
          };
      };
  };
  var dateFromMs = function (ms) {
      var i = Data_DateTime_Instant.instant(ms);
      if (i instanceof Data_Maybe.Just) {
          return new Data_Maybe.Just(Data_DateTime.date(Data_DateTime_Instant.toDateTime(i.value0)));
      };
      if (i instanceof Data_Maybe.Nothing) {
          return Data_Maybe.Nothing.value;
      };
      throw new Error("Failed pattern match at Data.Teller.DateHelpers (line 57, column 5 - line 59, column 27): " + [ i.constructor.name ]);
  };
  exports["iterateDateRange"] = iterateDateRange;
  exports["dateFromMs"] = dateFromMs;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  ...
  var Data_Teller_DateHelpers = $PS["Data.Teller.DateHelpers"];
  var Data_Teller_GenTypes = $PS["Data.Teller.GenTypes"];
  var Data_Tuple = $PS["Data.Tuple"];
  var $$Math = $PS["Math"];                
  var weekdayNumbersToBinarySequence = function (xs) {
      return Data_Functor.map(Data_Functor.functorArray)(function (i) {
          var v = Data_Array.elemIndex(Data_Eq.eqInt)(i)(xs);
          if (v instanceof Data_Maybe.Just) {
              return 1;
          };
          if (v instanceof Data_Maybe.Nothing) {
          ...
          throw new Error("Failed pattern match at Data.Teller.HeartbeatGen (line 129, column 9 - line 131, column 25): " + [ v.constructor.name ]);
          ...
          return function (acc) {
              return function (xi) {
                  if (xi === 1) {
                      ...
                      throw new Error("Failed pattern match at Data.Teller.HeartbeatGen (line 148, column 18 - line 150, column 31): " + [ v.constructor.name ]);
                  };
                  return acc;
              };
          };
  ...
  var generateHeartbeat = function (dStart) {
      return function (dEnd) {
          return function (genFunc) {
              return Data_Teller_DateHelpers.iterateDateRange(dStart)(dEnd)(genFunc);
          };
      };
  };
  var genXthDayOfMonth = function (x) {
      return function (dt) {
          ...
          var $11 = Data_Eq.eq(Data_Date_Component.eqDay)(xAsDay)(dateDay);
          if ($11) {
              return 1;
          };
          return 0;
  ...
  var genWeekend = function (dt) {
      ...
      throw new Error("Failed pattern match at Data.Teller.HeartbeatGen (line 78, column 5 - line 85, column 20): " + [ wkd.constructor.name ]);
  };
  ...
  var genWeekday = function (dt) {
      ...
      throw new Error("Failed pattern match at Data.Teller.HeartbeatGen (line 65, column 5 - line 72, column 20): " + [ wkd.constructor.name ]);
  };
  var genWeekdaysMatcher = new Data_Tuple.Tuple(genWeekday, new Data_Teller_GenTypes.EveryWeekdayTrendDescription({
      pricing: [  ]
  }));
  var genSpecificWeekday = function (w) {
      return function (dt) {
          var wkd = Data_Date.weekday(dt);
          var $14 = Data_Eq.eq(Data_Date_Component.eqWeekday)(wkd)(w);
          if ($14) {
              return 1;
          };
          return 0;
  ...
  var genLastWeekDay = function (w) {
      return function (dt) {
          ...
          var $15 = isSameDay && daysUntilEndOfMonth < 7;
          if ($15) {
              return 1;
          };
          return 0;
  ...
  var binaryWeekPatternToMatcher = function (xs) {
      return function (dt) {
          ...
          throw new Error("Failed pattern match at Data.Teller.HeartbeatGen (line 136, column 5 - line 138, column 21): " + [ shouldOccur.constructor.name ]);
      };
  };
  ...
  exports["genWeekend"] = genWeekend;
  exports["genSpecificWeekday"] = genSpecificWeekday;
  exports["genLastWeekDay"] = genLastWeekDay;
  exports["genXthDayOfMonth"] = genXthDayOfMonth;
  exports["weekdayNumbersToBinarySequence"] = weekdayNumbersToBinarySequence;
  exports["binaryWeekPatternToMatcher"] = binaryWeekPatternToMatcher;
  exports["allHeartbeatMatchers"] = allHeartbeatMatchers;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Data.Teller.Forecast"] = $PS["Data.Teller.Forecast"] || {};
  var exports = $PS["Data.Teller.Forecast"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Date_Component = $PS["Data.Date.Component"];
  ...
  var Data_Tuple = $PS["Data.Tuple"];
  var generateTrendId = function (v) {
      if (v.value1 instanceof Data_Teller_GenTypes.MonthDayTrendDescription) {
          return "MonthDay_" + (Data_Show.show(Data_Show.showInt)(v.value1.value0.dayOfMonth) + ("_" + v.value0));
      };
      if (v.value1 instanceof Data_Teller_GenTypes.LastWeekdayTrendDescription) {
          return "LastWeekday_" + (Data_Show.show(Data_Show.showInt)(v.value1.value0.weekday) + ("_" + v.value0));
      };
      if (v.value1 instanceof Data_Teller_GenTypes.SpecificWeekdayTrendDescription) {
          return "SpecificWeekday_" + (Data_Show.show(Data_Show.showInt)(v.value1.value0.weekday) + ("_" + v.value0));
      };
      if (v.value1 instanceof Data_Teller_GenTypes.WeekdayTrendDescription) {
          return "Weekday_" + (Data_Show.show(Data_Show.showArray(Data_Show.showInt))(v.value1.value0.weekdays) + ("_" + v.value0));
      };
      if (v.value1 instanceof Data_Teller_GenTypes.EveryWeekdayTrendDescription) {
          return "EveryWeekday_" + v.value0;
      };
      if (v.value1 instanceof Data_Teller_GenTypes.WeekendTrendDescription) {
          return "Weekend_" + v.value0;
      };
      throw new Error("Failed pattern match at Data.Teller.Forecast (line 90, column 5 - line 96, column 63): " + [ v.value1.constructor.name ]);
  };
  var trendTupleToStruct = function (v) {
      return {
          id: generateTrendId(new Data_Tuple.Tuple(v.value0, v.value1)),
          trend: v.value1,
          merchant: v.value0
      };
  }; 
  var createMatcher = function (trend) {
      if (trend instanceof Data_Teller_GenTypes.MonthDayTrendDescription) {
          return Data_Teller_HeartbeatGen.genXthDayOfMonth(trend.value0.dayOfMonth);
      };
      if (trend instanceof Data_Teller_GenTypes.LastWeekdayTrendDescription) {
          return Data_Teller_HeartbeatGen.genLastWeekDay(Data_Enum.toEnumWithDefaults(Data_Date_Component.boundedEnumWeekday)(Data_Date_Component.Monday.value)(Data_Date_Component.Friday.value)(trend.value0.weekday));
      };
      if (trend instanceof Data_Teller_GenTypes.SpecificWeekdayTrendDescription) {
          return Data_Teller_HeartbeatGen.genSpecificWeekday(Data_Enum.toEnumWithDefaults(Data_Date_Component.boundedEnumWeekday)(Data_Date_Component.Monday.value)(Data_Date_Component.Friday.value)(trend.value0.weekday));
      };
      if (trend instanceof Data_Teller_GenTypes.WeekdayTrendDescription) {
          return Data_Teller_HeartbeatGen.binaryWeekPatternToMatcher(Data_Teller_HeartbeatGen.weekdayNumbersToBinarySequence(trend.value0.weekdays));
      };
      if (trend instanceof Data_Teller_GenTypes.EveryWeekdayTrendDescription) {
          return Data_Teller_HeartbeatGen.genWeekday;
      };
      if (trend instanceof Data_Teller_GenTypes.WeekendTrendDescription) {
          return Data_Teller_HeartbeatGen.genWeekend;
      };
      throw new Error("Failed pattern match at Data.Teller.Forecast (line 79, column 5 - line 85, column 51): " + [ trend.constructor.name ]);
  };
  var doesTrendOccurOnDay = function (trend) {
      return function (dt) {
          var matcher = createMatcher(trend);
          var v = matcher(dt);
          if (v === 1) {
              return true;
          };
  ...
  var pickTrendsOccurringOnDay = function (dt) {
      return function (ts) {
          return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (ids) {
              return function (v) {
                  var v1 = doesTrendOccurOnDay(v.trend)(dt);
                  if (v1) {
                      return Data_Array.snoc(ids)(v.id);
                  };
                  if (!v1) {
                      return ids;
                  };
                  throw new Error("Failed pattern match at Data.Teller.Forecast (line 110, column 9 - line 112, column 25): " + [ v1.constructor.name ]);
              };
          })([  ])(ts);
      };
  };
  var createForecastForDay = function (ts) {
      return function (dt) {
          var instant = Data_DateTime_Instant.fromDate(dt);
          var v = Data_DateTime_Instant.unInstant(instant);
          var ids = pickTrendsOccurringOnDay(dt)(ts);
          return {
              dateTimestampMs: v,
              trendIds: ids
          };
  ...
  var forecast = function (sDate) {
      return function (eDate) {
          return function (trends) {
              var dayForecaster = createForecastForDay(trends);
              var forecastedDays = Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Teller_DateHelpers.dateFromMs(sDate))(function (s) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Teller_DateHelpers.dateFromMs(eDate))(function (e) {
                      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Data_Teller_DateHelpers.iterateDateRange(s)(e)(dayForecaster));
                  });
              });
              if (forecastedDays instanceof Data_Maybe.Just) {
                  return {
                      days: forecastedDays.value0
                  };
              };
              if (forecastedDays instanceof Data_Maybe.Nothing) {
                  return {
                      days: [  ]
                  };
              };
              throw new Error("Failed pattern match at Data.Teller.Forecast (line 129, column 5 - line 131, column 41): " + [ forecastedDays.constructor.name ]);
          };
      };
  };
  exports["trendTupleToStruct"] = trendTupleToStruct;
...
(function($PS) {
  ...
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Data_Set = $PS["Data.Set"];
  var Data_Teller_Forecast = $PS["Data.Teller.Forecast"];
  var Data_Teller_GenTypes = $PS["Data.Teller.GenTypes"];
  var Data_Teller_HeartbeatGen = $PS["Data.Teller.HeartbeatGen"];
  ...
  var getMatcherResults = function (v) {
      ...
      throw new Error("Failed pattern match at Data.Teller.Trend (line 65, column 5 - line 68, column 22): " + [ dates.constructor.name ]);
  };
  ...
  var identifyTrends = function (xs) {
      ...
      return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
          return function (merchant) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)(acc)([ Data_Teller_Forecast.trendTupleToStruct(new Data_Tuple.Tuple(merchant, v.value0)) ]);
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return acc;
              };
              throw new Error("Failed pattern match at Data.Teller.Trend (line 42, column 9 - line 48, column 27): " + [ v.constructor.name ]);
          };
      })([  ])(merchants);
  };
...
(function($PS) {
  ...
  var forecast = Data_Teller_Forecast.forecast;
  exports["forecast"] = forecast;
  exports["identifyTrends"] = identifyTrends;
  exports["isMonthDayTrendDescription"] = isMonthDayTrendDescription;
  exports["isLastWeekdayTrendDescription"] = isLastWeekdayTrendDescription;
