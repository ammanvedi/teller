...
(function($PS) {
  ...
  var getMatcherResults = function (v) {
      ...
      throw new Error("Failed pattern match at Data.Teller.Trend (line 51, column 5 - line 54, column 22): " + [ dates.constructor.name ]);
  };
  ...
  var identifyTrends = function (xs) {
      ...
      return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
          return function (merchant) {
              ...
              throw new Error("Failed pattern match at Data.Teller.Trend (line 33, column 9 - line 35, column 27): " + [ v.constructor.name ]);
          };
      })([  ])(merchants);
  };
