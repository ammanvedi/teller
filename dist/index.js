...
(function($PS) {
  ...
  var trendDescriptionShow = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Data.Teller.GenTypes (line 61, column 1 - line 67, column 69): " + [ v.constructor.name ]);
  });
  ...
  var heartbeatMatchResultOrd = new Data_Ord.Ord(function () {
      ...
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Data.Teller.GenTypes (line 86, column 1 - line 92, column 29): " + [ v.constructor.name, v1.constructor.name ]);
      };
  });
