...
(function($PS) {
  ...
  var safeAdjust = function (d) {
      return function (dt) {
          ...
          throw new Error("Failed pattern match at Data.Teller.DateHelpers (line 38, column 5 - line 40, column 22): " + [ maybeRes.constructor.name ]);
      };
  };
  ...
  var forecast = function (sDate) {
      return function (eDate) {
          return function (trends) {
              ...
              var forecastedDays = Data_Teller_DateHelpers.iterateDateRange(sDate)(eDate)(dayForecaster);
              return {
                  days: forecastedDays
              };
          };
