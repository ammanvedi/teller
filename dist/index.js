...
(function($PS) {
  ...
  var EveryWeekdayTrendDescription = (function () {
      function EveryWeekdayTrendDescription() {

      };
      EveryWeekdayTrendDescription.value = new EveryWeekdayTrendDescription();
      return EveryWeekdayTrendDescription;
  })();
  var WeekendTrendDescription = (function () {
      function WeekendTrendDescription() {

      };
      WeekendTrendDescription.value = new WeekendTrendDescription();
  ...
  var trendDescriptionShow = new Data_Show.Show(function (v) {
      if (v instanceof WeekdayTrendDescription) {
          return "Occurs on these weekdays " + Data_Show.show(Data_Show.showArray(Data_Show.showInt))(v.value0.weekdays);
      };
      if (v instanceof MonthDayTrendDescription) {
          return "Occurs every month on " + Data_Show.show(Data_Show.showInt)(v.value0.dayOfMonth);
      };
      if (v instanceof LastWeekdayTrendDescription) {
          return "Occurs on the last " + (Data_Show.show(Data_Show.showInt)(v.value0.weekday) + "of each month");
      };
      if (v instanceof SpecificWeekdayTrendDescription) {
          return "Occurs every week on " + Data_Show.show(Data_Show.showInt)(v.value0.weekday);
      };
      if (v instanceof EveryWeekdayTrendDescription) {
          return "Occurs on weekdays";
      };
      if (v instanceof WeekendTrendDescription) {
          return "Occurs on saturdays and sundays";
      };
      throw new Error("Failed pattern match at Data.Teller.GenTypes (line 21, column 1 - line 27, column 69): " + [ v.constructor.name ]);
  });
  ...
  var heartbeatMatchResultOrd = new Data_Ord.Ord(function () {
      ...
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Data.Teller.GenTypes (line 46, column 1 - line 52, column 29): " + [ v.constructor.name, v1.constructor.name ]);
      };
  });
...
(function($PS) {
  ...
  // Weekends
  var genWeekendMatcher = new Data_Tuple.Tuple(genWeekend, Data_Teller_GenTypes.WeekendTrendDescription.value);
  ...
  // Weekdays
  var genWeekdaysMatcher = new Data_Tuple.Tuple(genWeekday, Data_Teller_GenTypes.EveryWeekdayTrendDescription.value);
...
(function($PS) {
  ...
  var indexedTupleOrd = new Data_Ord.Ord(function () {
      ...
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Data.Teller.SignalProcessing (line 22, column 1 - line 26, column 25): " + [ v.constructor.name, v1.constructor.name ]);
      };
  });
  var getMatchingValues = function (v) {
      return function (v1) {
          ...
          var zipped = Data_Array.zip(v)(v1);
          return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
              return function (v2) {
                  var $59 = v2.value0 === v2.value1;
                  if ($59) {
                      return acc + 1 | 0;
                  };
                  return acc;
  ...
  // two binary values
  var naiveSignalMatch = function (v) {
      return function (v1) {
          if (v.length === 0 && v1.length === 0) {
              return 100.0;
          };
          ...
          var valsThatMatch = Data_Int.toNumber(getMatchingValues(v)(v1));
          var listLeng = Data_Int.toNumber(Data_Array.length(v));
          return (valsThatMatch / listLeng) * 100.0;
      };
  }; 
  ...
  var chunkConsec = function (xs) {
      var safePair = function (ix) {
          return function (val) {
              ...
              throw new Error("Failed pattern match at Data.Teller.SignalProcessing (line 136, column 13 - line 138, column 30): " + [ v.constructor.name ]);
          };
      };
          ...
          return function (v2) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  ...
                  if (violatesWindow) {
                      ...
                      throw new Error("Failed pattern match at Data.Teller.SignalProcessing (line 87, column 14 - line 89, column 26): " + [ v3.constructor.name ]);
                  };
                  return reWrapped;
              };
              throw new Error("Failed pattern match at Data.Teller.SignalProcessing (line 83, column 1 - line 83, column 77): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  ...
  var atIndex = function (xs) {
      return function (n) {
          ...
          throw new Error("Failed pattern match at Data.Teller.SignalProcessing (line 32, column 5 - line 34, column 23): " + [ wrappedIndex.constructor.name ]);
      };
  };
  ...
  exports["naiveSignalMatch"] = naiveSignalMatch;
...
(function($PS) {
      ...
      return function (dEnd) {
          return function (hb) {
              return function (v) {
                  ...
                  var signalMatch = Data_Teller_SignalProcessing.naiveSignalMatch(generatedHb)(hb);
  ...
  var getMatcherResults = function (v) {
      ...
      throw new Error("Failed pattern match at Data.Teller.Trend (line 53, column 5 - line 56, column 22): " + [ dates.constructor.name ]);
  };
  var identifyTrend = function (m) {
      return function (xs) {
          ...
          var $15 = period < 32.0;
          if ($15) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Debug_Trace.spy()("mr")(Data_Array.reverse(Data_Array.sort(Data_Teller_GenTypes.heartbeatMatchResultOrd)(getMatcherResults(xs))))))(function (matchers) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Foldable.maximum(Data_Teller_GenTypes.heartbeatMatchResultOrd)(Data_Foldable.foldableArray)(matchers))(function (maxMatch) {
                      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Data_Tuple.snd(Data_Newtype.unwrap(Data_Teller_GenTypes.heartbeatMatchResultNewType)(maxMatch)));
                  });
              });
          };
          return Data_Maybe.Nothing.value;
  ...
  var identifyTrends = function (xs) {
      var merchants = Data_Array.fromFoldable(Data_Set.foldableSet)(Data_Teller_Transaction.uniqueMerchants(xs));
      return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
          return function (merchant) {
              var v = identifyTrend(merchant)(Data_Array.sort(Data_Teller_Transaction.transactionOrd)(Data_Teller_Transaction.transactionsForMerchant(xs)(merchant)));
              if (v instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at Data.Teller.Trend (line 35, column 9 - line 37, column 27): " + [ v.constructor.name ]);
          };
      })([  ])(merchants);
  };
